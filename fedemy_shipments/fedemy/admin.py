...
from .models.ordersuserscompanies import OrderUserCustomer
...
from .models.userscustomerstype import UserCustomersType
...
admin.site.register(OrderUserCustomer)
...
admin.site.register(UserCustomersType)